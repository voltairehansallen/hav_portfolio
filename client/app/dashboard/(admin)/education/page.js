...
export default function EducationDashboardPage() {
  ...
  return (
    <div>
      <h1 className="mb-6 font-display text-2xl font-bold">Education</h1>

      <form
        onSubmit={handleSubmit}
        className="mb-8 grid max-w-2xl gap-4 rounded border border-panel-border bg-panel p-4 sm:grid-cols-2"
      >
        <Field label="établissement" name="school" value={form.school} onChange={handleChange} required />
        <Field label="diplôme" name="degree" value={form.degree} onChange={handleChange} required />
        <Field label="domaine" name="fieldOfStudy" value={form.fieldOfStudy} onChange={handleChange} />
